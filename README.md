...
* **[thephpleague/config](https://github.com/thephpleague/config)** ([v1.1.0](https://github.com/thephpleague/config/releases/tag/v1.1.0), 3 days ago)<br>Simple yet expressive schema-based configuration library for PHP apps
