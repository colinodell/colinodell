...
* **[thephpleague/config](https://github.com/thephpleague/config)** ([v1.1.1](https://github.com/thephpleague/config/releases/tag/v1.1.1), 4 weeks ago)<br>Simple yet expressive schema-based configuration library for PHP apps
