...
* **[seatgeek/backstage-plugins](https://github.com/seatgeek/backstage-plugins)** ([@seatgeek/backstage-plugin-slack-catalog-backend@2.1.0](https://github.com/seatgeek/backstage-plugins/releases/tag/%40seatgeek/backstage-plugin-slack-catalog-backend%402.1.0), 2 weeks ago)<br>SeatGeek Backstage Plugins Collection
* **[wayfair-incubator/pygitops](https://github.com/wayfair-incubator/pygitops)** ([v0.16.2](https://github.com/wayfair-incubator/pygitops/releases/tag/v0.16.2), 3 weeks ago)<br>Wrapper for low-level git logic. Useful for systems automating git operations.
...
* **[thephpleague/commonmark](https://github.com/thephpleague/commonmark)** ([2.8.2](https://github.com/thephpleague/commonmark/releases/tag/2.8.2), 1 months ago)<br>Highly-extensible PHP Markdown parser which fully supports the CommonMark and GFM specs.
