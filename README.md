...
* **[thephpleague/commonmark](https://github.com/thephpleague/commonmark)** ([2.0.0-beta3](https://github.com/thephpleague/commonmark/releases/tag/2.0.0-beta3), 3 days ago)<br>Highly-extensible PHP Markdown parser which fully supports the CommonMark and GFM specs.
* **[thephpleague/commonmark](https://github.com/thephpleague/commonmark)** ([2.0.0-beta2](https://github.com/thephpleague/commonmark/releases/tag/2.0.0-beta2), 1 weeks ago)<br>Highly-extensible PHP Markdown parser which fully supports the CommonMark and GFM specs.
* **[thephpleague/config](https://github.com/thephpleague/config)** ([v1.1.0](https://github.com/thephpleague/config/releases/tag/v1.1.0), 3 weeks ago)<br>Simple yet expressive schema-based configuration library for PHP apps
* **[unleashedtech/php-coding-standard](https://github.com/unleashedtech/php-coding-standard)** ([v3.1.0](https://github.com/unleashedtech/php-coding-standard/releases/tag/v3.1.0), 4 weeks ago)<br>Opinionated, strict PHP CodeSniffer ruleset used by Unleashed Technologies
