...
* **[thephpleague/config](https://github.com/thephpleague/config)** ([v1.2.0](https://github.com/thephpleague/config/releases/tag/v1.2.0), 6 days ago)<br>Simple yet expressive schema-based configuration library for PHP apps
