...
* **[wayfair-incubator/pygitops](https://github.com/wayfair-incubator/pygitops)** ([v0.18.0](https://github.com/wayfair-incubator/pygitops/releases/tag/v0.18.0), 5 days ago)<br>Wrapper for low-level git logic. Useful for systems automating git operations.
